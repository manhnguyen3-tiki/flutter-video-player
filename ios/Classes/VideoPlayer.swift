...
class VideoPlayerFactory: NSObject, FlutterPlatformViewFactory {
    ...
    static func register(with registrar: FlutterPluginRegistrar) {
        ...
        registrar.register(plugin, withId: "tk.vn/NativeVideoPlayer")
    }
...
class VideoPlayer: NSObject, FlutterPlugin, FlutterStreamHandler, FlutterPlatformView {
    ...
    deinit {
        print("[dealloc] tk.vn/NativeVideoPlayer")
    }
    ...
    private func setupEventChannel(viewId: Int64, messenger:FlutterBinaryMessenger, instance:VideoPlayer) {
        ...
        instance.eventChannel = FlutterEventChannel(name: "tk.vn/NativeVideoPlayerEventChannel_" + String(viewId), binaryMessenger: messenger, codec: FlutterJSONMethodCodec.sharedInstance())
    ...
    private func setupMethodChannel(viewId: Int64, messenger:FlutterBinaryMessenger) {
        ...
        let nativeMethodsChannel = FlutterMethodChannel(name: "tk.vn/NativeVideoPlayerMethodChannel_" + String(viewId), binaryMessenger: messenger);
